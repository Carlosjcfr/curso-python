...
print("\nEjercicio 1:")
for i in range(1,10):  # El paso 2 asegura que solo se generen impares
  print(i)
...
for i in range(start, end +1):
  suma += i
print(f"La suma de {start} a {end} es: {suma}")

# Ejercicio 6: Tabla de multiplicar
# Pide al usuario que introduzca un número.
# Imprime la tabla de multiplicar de ese número (del 1 al 10) usando un bucle for y range().
print("\nEjercicio 6:")
factor = int(input("Indica un numero: "))
for i in range(1*factor, factor * 10+1, factor):
  print(i)

print("\nEjercicio 6b:")
for i in range(1, 11):
  print(f"{i} x {factor} es: {i*factor}")